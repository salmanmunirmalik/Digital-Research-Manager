...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://localhost:5432/digital_research_manager',
});
    ...
    const sampleEntries = [
      {
        ...
        lab_id: 'c8ace470-5e21-4d3b-ab95-da6084311657', // Use a valid UUID
        author_id: '4fd07593-fdfd-46ca-890c-f7875e3c47fb',
        tags: ['PCR', 'Protocol'],
