...
-- Stores AI-ready content with embeddings for semantic search
...
CREATE TABLE IF NOT EXISTS user_ai_content (
    ...
    -- AI-ready features
    embedding JSONB, -- Embedding vector stored as JSONB (use vector type if pgvector extension is installed)
...
-- Vector similarity search index (using pgvector if available)
-- CREATE INDEX IF NOT EXISTS idx_user_ai_content_embedding ON user_ai_content 
