...
export const AtomIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M20.2 20.2c2.04-2.03.02-7.26-4.5-11.3-4.52-4.04-9.27-6.54-11.3-4.5-2.04 2.03-.02 7.26 4.5 11.3 4.52 4.04 9.27 6.54 11.3 4.5Z" />
    <path d="M15.7 15.7c4.52-4.05 6.54-9.27 4.5-11.3-2.03-2.04-7.26-.02-11.3 4.5-4.05 4.52-6.54 9.27-4.5 11.3 2.03 2.04 7.26.02 11.3-4.5Z" />
  </svg>
);
